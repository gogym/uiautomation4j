...
import io.getbit.uiautomation.linux.dbus.AtspiText;
import io.getbit.uiautomation.linux.dbus.AtspiValue;
...
public class LinuxValuePattern implements ValuePattern {
    ...
    public boolean isReadOnly() {
        // 检查是否有 editable 状态
        return !element.hasState(io.getbit.uiautomation.linux.ax.AtspiConstants.STATE_EDITABLE);
    }
}
