...
import io.getbit.uiautomation.linux.ax.AtspiConnection;
import io.getbit.uiautomation.linux.ax.AtspiElement;
import io.getbit.uiautomation.linux.pattern.*;
 ...
 * </ol>
 *
 * @see io.getbit.uiautomation.mac.MacControlBackend
 */
public class LinuxControlBackend implements ControlBackend {
    ...
    public void sendKeys(Control control, String keys) {
        AtspiElement element = getAtspiElement(control);
        element.grabFocus();
        io.getbit.uiautomation.linux.keyboard.Keyboard.sendKeys(keys);
    }
    ...
    public void click(Control control) {
        ...
        io.getbit.uiautomation.linux.mouse.Mouse.click(centerX, centerY);
    }
    ...
    public void doubleClick(Control control) {
        ...
        int centerX = rect[0] + rect[2] / 2;
        int centerY = rect[1] + rect[3] / 2;
        io.getbit.uiautomation.linux.mouse.Mouse.doubleClick(centerX, centerY);
    }
    ...
    public void rightClick(Control control) {
        ...
        int centerX = rect[0] + rect[2] / 2;
        int centerY = rect[1] + rect[3] / 2;
        io.getbit.uiautomation.linux.mouse.Mouse.rightClick(centerX, centerY);
    }
    ...
    public void captureToImage(Control control, String filePath) {
        AtspiElement element = getAtspiElement(control);
        int[] rect = element.getBoundingRectangle();
        io.getbit.uiautomation.linux.screenshot.Screenshot.captureRegion(
