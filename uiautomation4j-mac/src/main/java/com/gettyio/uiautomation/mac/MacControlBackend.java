...
import com.gettyio.uiautomation.mac.ax.*;
import com.gettyio.uiautomation.mac.pattern.*;
 ...
 * </ul>
 *
 * @see com.gettyio.uiautomation.win.WinControlBackend
 */
public class MacControlBackend implements ControlBackend {
    ...
    public void sendKeys(Control control, String keys) {
        ...
        // 通过 Keyboard 工具类发送按键
        com.gettyio.uiautomation.mac.keyboard.Keyboard.sendKeys(keys);
    }
    ...
    public void click(Control control) {
        ...
        com.gettyio.uiautomation.mac.mouse.Mouse.click(centerX, centerY);
    }
    ...
    public void doubleClick(Control control) {
        ...
        int centerX = rect[0] + rect[2] / 2;
        int centerY = rect[1] + rect[3] / 2;
        com.gettyio.uiautomation.mac.mouse.Mouse.doubleClick(centerX, centerY);
    }
    ...
    public void rightClick(Control control) {
        ...
        int centerX = rect[0] + rect[2] / 2;
        int centerY = rect[1] + rect[3] / 2;
        com.gettyio.uiautomation.mac.mouse.Mouse.rightClick(centerX, centerY);
    }
    ...
    public void captureToImage(Control control, String filePath) {
        AXUIElement element = getAXElement(control);
        int[] rect = element.getBoundingRectangle();
        com.gettyio.uiautomation.mac.screenshot.Screenshot.captureRegion(
